				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							<input type="text" id='firstName' name="firstName" class="form-control" placeholder="Enter Vendor Name" onkeypress="return isAlphabet(event)" />
						</div>
					</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<div class="input-group">
							...
							</span> <input type="text" id='companyNumber' maxlength="10" name="companyNumber" onkeypress="return isNumber(event)"
